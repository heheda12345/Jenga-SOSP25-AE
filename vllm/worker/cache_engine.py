...
from vllm.config import CacheConfig, DeviceConfig, KVCacheConfig, KVPageType, LAPageType, ModelConfig, ParallelConfig, SharedTokenType
...
class CacheEngineV3:
    ...
    def _allocate_kv_cache(
        ...
        for layer_id, component in self.kv_cache_config.components.items():
            ...
            elif isinstance(component, LAPageType):
                shape = (component.num_elements // component.page_size,
                         *component.page_shape)
