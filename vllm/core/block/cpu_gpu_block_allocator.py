...
class CpuGpuBlockAllocator(DeviceAwareBlockAllocator):
    ...
    def allocate_immutable_blocks(self, prev_block: Optional[Block],
                                  ...
                                  device: Device, group_id_hash: int,
                                  seq_id: int,
                                  start_from_block: int) -> List[Block]:
        ...
        return self._allocators[device].allocate_immutable_blocks(
            ...
            seq_id=seq_id,
            start_from_block=start_from_block)
    ...
    def get_blocks_is_computed(self, block_ids: List[int]) -> List[bool]:
        device = Device.GPU
        return self._allocators[device].get_blocks_is_computed(block_ids)
