...
class SmallBlockIDAllocator:
    ...
    def __init__(self, ref_counter: RefCounter,
                 ...
                 large_small_ratio: int, max_num_large_blocks: int):
        ...
        self.max_num_large_blocks = max_num_large_blocks
    ...
    def allocate_block_id(
        ...
        if len(self.free_block_id_with_prefer[seq_id]) == 0:
            if self.new_large_block_quota > 0 and self.num_large_block < self.max_num_large_blocks:
