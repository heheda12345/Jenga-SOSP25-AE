...
class BlockSpaceManagerV3(BlockSpaceManager):
    ...
    def can_allocate(self, 
        ...
        # NOTE: this is only for prefill?
        is_prompt = seq_group.is_prefill()
        get_top_k = self.top_k_func.get_top_k_for_seq(is_prompt, seq, update=False)
        print(f"Is prompt: {is_prompt}, get_top_k: {get_top_k}")
        
        # NOTE: allocate largest layer token ids 
        num_required_blocks = BlockTable.get_num_required_blocks(
            seq.get_token_ids(), # LARGEST K 
    ...
    def can_append_slots(self, seq_group: SequenceGroup,
        ...
        for seq in seq_group.get_seqs(status=SequenceStatus.RUNNING):
            ...
            # TODO: Decrease (k decreases), return 0 
            # TODO: increase, calculate 
            num_touched_blocks += (
