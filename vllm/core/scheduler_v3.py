...
class Scheduler:
    ...
    def __init__(
        ...
        self.prefill_config = self.cache_config.prefill_config
        self.decode_config = self.cache_config.generation_config
    ...
    def calculate_k(
        ...
        schedule_gen_decay_ratio: float,
        exceed_length_to_compress: int,
        recent_length: int,
        gen_compress_ratio: float,
    ) -> None:
        """
    ...
    def update_parameter(
        recent_attn_weights_last_shape_list: List[int], 
        layer_id: int, 
        recent_length: int, 
        exceed_length_to_compress: int, 
        topk: int, 
        ...
        """
        Update parameter for recent_attn_weights_last_shape_list
        """
